...
describe('lesson resolver', () => {
  ...
  it('should call getAll function and return lesson for on lesson', async () => {
    ...
    const response = await lessonResolver.getLessons(null, {}, MOCK_STUDENT_CONTEXT);
  ...
  it('should call updateLesson and return updated lesson', async () => {
    ...
    const result = await lessonResolver.updateLesson(
      null,
      { id: '5b217b030825622c97d3757f', lesson: expected },
      MOCK_CONTEXT,
    );
    expect(result).toEqual(expected);
